...
class EmployeeWage implements IEmployeeWageComputation
{
    ...
    {
        EmployeeWage employeeWageCalculation = new EmployeeWage(3);
        employeeWageCalculation.addCompany("Microsoft", 4, 30, 100);
        employeeWageCalculation.addCompany("Google", 5, 40, 170);
        employeeWageCalculation.addCompany("Apple", 9, 10, 70);
        employeeWageCalculation.calculateTotalWage();
    }
}